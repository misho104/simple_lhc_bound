...
EmptyMarker[name_, OptionsPattern[]] := Graphics[{
    EdgeForm@Directive[CurrentValue["Color"], JoinForm["Round"], AbsoluteThickness[OptionValue[Thickness]Pixel], Opacity[1]],
...
If[IsPPMLoaded === True,
  ...
  marker[i_Integer, options___] := If[TrueQ[i>0], marker[Mod[i-1, Length[markerNames]]+1, options], Message[marker::partd]; Abort[]];
...
RemoveLabels = {#[[1]], Spacer[List[0,0]], #[[3]]} &/@ # &;
...
] &/@ {Plot, LogPlot, LogLogPlot, LogLinearPlot, ListPlot, ListLogPlot, ListLogLogPlot, ListLogLinearPlot, ContourPlot, ListContourPlot, StackedListPlot};
...
OverrideTicks[xTick1:(_List|Automatic), yTick1:(_List|Automatic), xTick2:(_List|Automatic), yTick2:(_List|Automatic)] := Function[plot,
  Module[{tmp, xOrig1=None, yOrig1=None, xOrig2=None, yOrig2=None, xNew1, xNew2, yNew1, yNew2, xGrid, yGrid},
    ...
    xGrid = Select[Join[xNew1, xNew2], Head[#[[2]]]=!=Spacer&][[All,1]] // DeleteDuplicates;
    yGrid = Select[Join[yNew1, yNew2], Head[#[[2]]]=!=Spacer&][[All,1]] // DeleteDuplicates;
